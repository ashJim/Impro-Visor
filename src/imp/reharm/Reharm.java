...
/**
 * The Reharm class is the abstract superclass for all the reharmonisation modes in Impro-Visor. 
 * These modes are available via the pull down menu next to the Reharm button in the Impro-Visor GUI. 
 * It provides infrastructure for the reharmonisation system, as well as abstract methods and helper 
 * methods for the subclasses to implement. Some of it's helper methods are fundamental to the 
 * reharmonisation process, while others provide additional options to the developer of 
 * the subclass and can be used at their discretion, depending on the goals of the implementation.
 * @author Jim Ashford
 */
public abstract class Reharm {
    ...
    /**
     * The HashMap of potential chord choices for each note in the given key signature.
     */
    ...
    /**
     * An array of locked slots. Locked slots cannot be edited until they have been 'unlocked'.
     */
     ...
     * @return A two-dimensional array of chord groups, each group matching the index of a note in the scale.
     */
    public abstract String[][] generateSubstitutions(String[] chords);
    /**
     * This method sets the frequency at which new chords will be generated. Simply return the required length 
     * in slots between chords.
     */
    public abstract int getChordDuration();
    /**
     * This method is run at every point a new chord is to be placed. It uses the notes on the stave 
     * to decide how chords will be picked, based on the keyChords HashMap of notes and suitable chords.
    ...
    /**
     * This method is run after implementChordChoices has finished assigning chords to each assignable
     * slot. It checks the chords that have been placed and adjusts them for more cohesion from one to 
     * the next.
     * @param slot The slot at which to check the chord. We iterate through the chordSlots 
     * and implement this method for each.
     */
    ...
    /* Useful in implementChordChoice() and adjustChordChoice() */

    /**
     * Checks whether a slot is locked.
    ...
    /**
     * Checks whether the chord at the given slot is the given diatonic chord number within the key.
     * @param slot The slot at which to check to chord.
     * @param chordNumber The chord number to check the chord against.
     * @return true if the given chord is the given chord number, false otherwise.
     */
    ...
    /**
     * Checks whether the given slot is in the last bar of the piece.
     * @param slot The slot to check.
     * @return true is the given slot is in the last bar, false otherwise.
     */
    ...
    /**
     * Locks a slot so that the chord cannot be changed.
    ...
    /**
     * Unlocks a slot so that the chord can be changed.
     * @param slot The slot to be unlocked.
     */
    ...
    /**
     * Gets the root notes of all of the diatonic chords in the key that are the
     * best matches for the notes in the given slot.
     * @param slot The slot to check.
     * @return An ArrayList containing best matches for the given slot.
     */
    ...
    /**
     * Chooses from the best chord matches for the notes in the given slot, then sets that chord.
     * @param slot The slot to choose a chord for.
     * @return The Chord that has been set  in the given slot.
     */
    ...
    /**
     * Puts a chord in the given destination slot that is different to the one at the given source slot.
     * @param sourceSlot The slot with chord that should not be set.
     * @param destSlot The slot in which to set the different chord.
     */
    ...
    /**
     * Sets the diatonic chord of the given chord number in the given slot.
     * @param slot The slot in which to place the chord.
     * @param chordNumber The chord number within the key to place.
     */
     ...
     */
    private void setKeyChords(String[] notes, String[][] chordSets) {
        if(keyChords == null) {
     ...
     */
    private void populateDiatonicChordSets(String[][] destination, int indexToFill, String[] source) {
     ...
     * @param source The chords to use to populate the destination chordSets array.
     */
    private void populateOutsideChordSets(String[][] destination, int indexToFill, String[] source) {
     ...
     */
    private String[] generateTritoneSubs() {
     ...
     */
    private String[] generateNonDiatonicDimChords() {
     ...
     */
    private String[] get7thArpeggio(String chord) {
     ...
     */
    private String random7thExtension(String chord) {
     ...
     */
    private String random7thAlteration(String chord) {
        String root = getRoot(chord).toUpperCase();
        Random random = new Random();
     ...
     * @return The new extended chord name.
     */
    private String randomExtension(String chord) {
        Random random = new Random();
    ...
    /**
     * Set up/reset the locked slots array list as an empty list.
     */
    ...
    /**
     * Remove all slots from the locked slots list.
     */
    ...
    /**
     * Returns an ArrayList containing all of the notes in the given slot.
     * @param slot The slot whose notes should be returned.
     * @return The notes in the given slot.
     */
    private ArrayList<String> getNotesInSlot(int slot) {
     ...
     */
    private void setChordFromNote(String noteToSetChordFrom, int chordChoiceIndex, int slotToPlaceChord) {
    ...
    /* Not currently in use, but could be useful for new Reharm mode subclasses */
    ...
    /**
     * Returns the most frequently occurring note between the given slot and the next slot.
     * @param slot The slot to start checking at.
